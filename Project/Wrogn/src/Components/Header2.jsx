...
export default function Header2() {
  return (
    <div className='w-full h-[75px] max-lg:h-[55px] flex items-center justify-between px-[50px] max-xl:px-[20px] max-lg:px-[16px]'>
      <div className='flex items-center justify-between'>
        <svg className='mr-[20px] max-lg:block hidden' xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24"><path fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 8h16M4 16h16"></path></svg>
        <img src="Wrogn_Logo.svg" alt="" className='w-[50px] max-lg:w-[40px]'/>
        <div className='max-lg:hidden flex flex-col justify-center ml-[50px] max-2xl:ml-[30px] w-[950px] max-2xl:w-[800px] font-semibold text-[13px]'>
            <div className='flex items-center justify-between'>
                <a href="">EOSS</a>
                <a href="">EXCLUSIVE</a>
                <div className='flex flex-col relative'>
                <a href="" id='all_products' className='peer'>ALL PRODUCTS</a>
                <div id='all_products_hover' className='absolute top-[30px] left-[-20px] px-[30px] py-[40px] w-max hidden grid-cols-2 gap-[30px] border rounded-xl'>
                ...
                <a href="" id='topwear'>TOPWEAR</a>
                     <div id='topwear_hover' className='absolute top-[30px] left-[-20px] w-max px-[30px] py-[40px] hidden grid-cols-2 gap-[30px] border rounded-xl'>
                    <div className='flex flex-col text-[13px]'>
                        <a href="">VIEW ALL</a>
                ...
                <div id='bottomwear_hover' className='absolute top-[30px] left-[-20px] px-[30px] py-[40px] hidden w-max grid-cols-2 gap-[30px] border rounded-xl'>
                    <div className='flex flex-col text-[13px]'>
                        <a href="">VIEW ALL</a>
                        <a href="" className='mt-[15px]'>VIEW ALL</a>
                        <a href="" className='mt-[15px]'>BESTSELLERS</a>
                ...
                <div id='footwear_hover' className='absolute top-[30px] left-[-20px] px-[30px] py-[40px] hidden w-max grid grid-cols-2 gap-[30px] border rounded-xl'>
                    <div className='flex flex-col text-[13px]'>
                        <a href="">VIEW ALL</a>
                        <a href="" className='mt-[15px]'>VIEW ALL</a>
                ...
                <div id='fresh_arrivals_hover' className='absolute top-[30px] left-[-20px] px-[30px] py-[40px] hidden w-max grid-cols-2 gap-[30px] border rounded-xl'>
                    <div className='flex flex-col text-[13px]'>
                        <a href="">VIEW ALL</a>
                ...
                <a href="" id='essentials'>ESSENTIALS</a>
                    <div id='essentials_hover' className='absolute top-[30px] left-[-20px] px-[30px] py-[40px] hidden w-max grid-cols-2 gap-[30px] border rounded-xl'>
                    <div className='flex flex-col text-[13px]'>
                        <a href="">VIEW ALL</a>
                        <a href="" className='mt-[15px]'>T-SHIRTS</a>
      ...
      <div className='flex items-center ml-[20px]'>
        <div className='w-[250px] max-2xl:w-[150px] max-xl:hidden h-[40px] rounded-md flex items-center p-[5px]' style={{border:"1px solid grey"}}>
        ...
        <svg className='ml-[10px]' xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24"><path fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11.5a7.5 7.5 0 1 1-15 0a7.5 7.5 0 0 1 15 0m-2.107 5.42l3.08 3.08"></path></svg>
